...
{
    /// <inheritdoc />
    public partial class AddAllPreviousTablesAndData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Multan", "Tech Solution", "123131232", "15542", "Punjab", "Shah Rukn e alam colony" },
                    { 2, "Genova", "Glovo", "4314133", "16754", "Liguria", "via di pre" }
                });
